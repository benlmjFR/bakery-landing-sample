...
const INFO = [
  {
    icon: <MapPin size={14} />,
    text: "195 & 23 Boulevard Voltaire, 75011 Paris",
  },
  {
    icon: <Mail size={14} />,
    text: "boulangerie@gmail.com",
    href: "mailto:boulangerie@gmail.com",
  },
    ...
    >
      ...
      >
        ...
        >
          Une question,
          <br />
          <em style={{ color: "rgba(255,240,236,0.72)", fontStyle: "italic" }}>
            un projet ?
          </em>
        </h2>
        <p
        ...
        >
          Commandes spéciales, entremets sur mesure, partenariats… notre équipe
        ...
        >
          {INFO.map(({ icon, text, href }) => (
            ...
            >
              <span style={{ color: "rgba(255,240,236,0.7)", flexShrink: 0 }}>
                {icon}
              </span>
              {href ? (
                <a
                  ...
                  onMouseLeave={(e) =>
                    (e.currentTarget.style.color = "rgba(255,240,236,0.82)")
                  }
                >
                  {text}
                </a>
      ...
      <motion.div
        ...
        style={{
          ...
          border: "1px solid var(--glass-form-border)",
          backdropFilter: "blur(30px)",
          WebkitBackdropFilter: "blur(30px)",
          borderRadius: "var(--radius-lg)",
          padding: "2.4rem",
          boxShadow: "0 18px 55px rgba(0,0,0,0.1)",
        }}
      >
        <form
        ...
        >
          ...
          <motion.button
            ...
            style={{
              background:
                "linear-gradient(135deg,var(--dark-soft),var(--dark))",
              color: "white",
              border: "none",
              padding: "0.9rem 2rem",
              borderRadius: "50px",
          ...
          {sent && (
            <p style={{ color: "rgba(255,242,238,0.95)", fontSize: "0.86rem" }}>
              ✅ Message envoyé ! Nous vous répondrons rapidement.
            </p>
          )}
          {error && (
            <p style={{ color: "rgba(255,200,190,0.9)", fontSize: "0.86rem" }}>
              {error}
            </p>
          )}
        </form>
